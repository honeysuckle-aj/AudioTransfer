...
from utils.vocoder.distribution import sample_from_discretized_mix_logistic
from utils.vocoder.display import *
from utils.vocoder.wavernn.audio import *
...
class WaveRNN(nn.Module):
    ...
    def generate(self, mels, batched, target, overlap, mu_law, progress_callback=None):
        ...
        min_len = min(wave_len,20*self.hop_length)
        fade_out = np.linspace(1,2,min_len)
        output[-min_len:] *= fade_out
